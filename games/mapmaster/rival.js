/* rival.js — Mapmaster: the rival racer. Same engine as Numbers' rival.js;
 * "topics" here are CONTINENTS — pacing comes from your recorded answer times
 * per continent (store.pace), so a rival is fast where you're fast and the
 * race stays close by construction.
 *
...
window.Rival = (function () {
  ...
  // rival racing you on Hard (typed answers) gets the same allowance you get.
  const DIFF_FACTOR = { easy: 0.85, medium: 1, hard: 1.35 };
