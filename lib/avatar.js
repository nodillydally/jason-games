...
window.Avatar = (function () {
  ...
  // of the hair mass. Both are derived at import time, not guessed.
  const ANIMS = {
    idle: [
      { f: 'idle-0', top: 1, cx: 13 }, { f: 'idle-1', top: 2, cx: 13 },
      { f: 'idle-2', top: 3, cx: 13 }, { f: 'idle-3', top: 3, cx: 13 },
      { f: 'idle-4', top: 2, cx: 13 },
    ],
    run: [
      { f: 'run-0', top: 1, cx: 13 }, { f: 'run-1', top: 3, cx: 13 },
      { f: 'run-2', top: 4, cx: 13 }, { f: 'run-3', top: 3, cx: 14 },
      { f: 'run-4', top: 3, cx: 14 },
    ],
    cheer: [
      { f: 'cheer-0', top: 1, cx: 13 }, { f: 'cheer-1', top: 2, cx: 13 },
      { f: 'cheer-2', top: 0, cx: 13 }, { f: 'cheer-3', top: 0, cx: 13 },
      { f: 'cheer-4', top: 2, cx: 13 },
    ],
    stumble: [
      { f: 'stumble-0', top: 1, cx: 13 }, { f: 'stumble-1', top: 1, cx: 13 },
      { f: 'stumble-2', top: 4, cx: 13 }, { f: 'stumble-3', top: 7, cx: 13 },
      { f: 'stumble-4', top: 5, cx: 13 },
    ],
  };
  // Straining is running harder, so it borrows the cycle and spends less time
  // on each frame — a separate generation would say the same thing twice.
  ANIMS.strain = ANIMS.run;
  ...
  function create(host, opts = {}) {
    const o = { ink: 'var(--p1)', gear: {}, pal: {}, ghost: false, tint: '', ...opts };
