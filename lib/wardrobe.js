/* lib/wardrobe.js — one character, one wardrobe, seven games feeding it.
 *
...
window.Wardrobe = (function () {
  ...
  const EXTRA_SLOTS = ['halo', 'orbit', 'wing', 'pet'];
  const PANEL_SLOTS = ['character', ...EXTRA_SLOTS, ...SLOTS, 'ink'];
  const SLOT_LABEL = { character: 'Who', halo: 'Halo', orbit: 'Mote', wing: 'Wings', pet: 'Pet', head: 'Head', face: 'Face', back: 'Back', hand: 'Hand', aura: 'Aura', ink: 'Ink' };
  ...
  const ITEMS = [
    ...
    /* ---- Spelling: the desk, plum ---- */
    { id: 'inkcap', name: "Scholar's Cap", slot: 'head', from: 'spelling', at: 2 },
    { id: 'nib', name: 'Fountain Nib', slot: 'hand', from: 'spelling', at: 3 },
    { id: 'proofspecs', name: "Proofreader's Specs", slot: 'face', from: 'spelling', at: 4 },
    { id: 'letterswirl', name: 'Drifting Letters', slot: 'aura', from: 'spelling', at: 5 },
    { id: 'lexicon', name: 'Pocket Lexicon', slot: 'hand', from: 'spelling', at: 6 },
    { id: 'plum', name: 'Plum', slot: 'ink', from: 'spelling', at: 7, ink: '#6B3F5E' },
    { id: 'beecap', name: 'Bee Cap', slot: 'head', from: 'spelling', at: 8 },
    { id: 'dictionary', name: 'The Dictionary', slot: 'hand', from: 'spelling', at: 10 },
    { id: 'wordcape', name: 'Cloak of Words', slot: 'back', from: 'spelling', at: 12 },
    { id: 'laurelpen', name: 'Editor’s Laurel', slot: 'head', from: 'spelling', at: 15 },
    { id: 'spellcrown', name: 'Crown of Letters', slot: 'head', from: 'spelling', at: 20 },

    /* ---- Memory: the practice kit, teal ---- */
    { id: 'recallband', name: 'Recall Band', slot: 'head', from: 'memory', at: 2 },
    { id: 'token', name: 'Memory Token', slot: 'hand', from: 'memory', at: 3 },
    { id: 'blindfold', name: 'Blindfold', slot: 'face', from: 'memory', at: 4 },
    { id: 'ninegrid', name: 'Lattice of Nine', slot: 'aura', from: 'memory', at: 5 },
    { id: 'beads', name: 'Counting Beads', slot: 'hand', from: 'memory', at: 6 },
    { id: 'teal', name: 'Teal', slot: 'ink', from: 'memory', at: 7, ink: '#2C6560' },
    { id: 'palacecirclet', name: 'Palace Circlet', slot: 'head', from: 'memory', at: 8 },
    { id: 'lociapack', name: 'Mnemonic Pack', slot: 'back', from: 'memory', at: 10 },
    { id: 'knotcord', name: 'Knotted Cord', slot: 'hand', from: 'memory', at: 12 },
    { id: 'mindveil', name: 'Mind’s Veil', slot: 'face', from: 'memory', at: 15 },
    { id: 'crownnine', name: 'Crown of Nine', slot: 'head', from: 'memory', at: 20 },
    ...
    { id: 'beecrown', name: "The Bee's Crown", slot: 'head', from: 'spelling',
      flag: 'spelling:clean-hard', legendary: true },
    { id: 'spanten', name: 'The Tenth Place', slot: 'aura', from: 'memory',
      flag: 'memory:span-ten', legendary: true },
    { id: 'matchtile', name: 'The Perfect Board', slot: 'hand', from: 'memory',
      flag: 'memory:perfect-board', legendary: true },
  ];

  /* ------------------------------- extras ---------------------------------
   *
   * The cheap half of the wardrobe, and the half worth expanding. None of
   * these attach to a body: a halo hovers above whatever the top of the sprite
   * is, a mote orbits, wings sit behind, a pet trots alongside. So one drawing
   * fits all fifteen characters and every one added later — the opposite of a
   * hat, which has to be re-anchored per head.
   */
  // Halos hover above the head.
  const HALOS = [
    { id: 'h-gold', name: 'Gilded Halo', slot: 'halo', from: 'numbers', at: 10 },
    { id: 'h-silver', name: 'Silver Halo', slot: 'halo', from: 'mapmaster', at: 10 },
    { id: 'h-runic', name: 'Runic Halo', slot: 'halo', from: 'chronicle', at: 12 },
    { id: 'h-rose', name: 'Rose Halo', slot: 'halo', from: 'reader', at: 12 },
    { id: 'h-frost', name: 'Frost Halo', slot: 'halo', from: 'mapmaster', at: 14 },
    { id: 'h-leafstar', name: 'Starleaf', slot: 'halo', from: 'briefing', at: 12 },
    { id: 'h-verdant', name: 'Verdant Crown', slot: 'halo', from: 'reader', at: 14 },
    { id: 'h-ember', name: 'Ember Ring', slot: 'halo', from: 'chronicle', at: 16 },
    { id: 'h-void', name: 'Void Ring', slot: 'halo', from: 'numbers', at: 16 },
  ];

  // Motes drift around the body.
  const ORBITS = [
    { id: 'o-crystal', name: 'Crystal Mote', slot: 'orbit', from: 'mapmaster', at: 3 },
    { id: 'o-flame', name: 'Flame Mote', slot: 'orbit', from: 'chronicle', at: 3 },
    { id: 'o-ruby', name: 'Ruby Mote', slot: 'orbit', from: 'numbers', at: 3 },
    { id: 'o-coin', name: 'Coin Mote', slot: 'orbit', from: 'briefing', at: 3 },
    { id: 'o-star', name: 'Star Mote', slot: 'orbit', from: 'reader', at: 3 },
    { id: 'o-shadow', name: 'Shadow Mote', slot: 'orbit', from: 'numbers', at: 7 },
    { id: 'o-amethyst', name: 'Amethyst Mote', slot: 'orbit', from: 'chronicle', at: 7 },
    { id: 'o-snow', name: 'Snow Mote', slot: 'orbit', from: 'mapmaster', at: 7 },
    { id: 'o-heart', name: 'Heart Mote', slot: 'orbit', from: 'briefing', at: 7 },
  ];

  // Wings and trails sit behind.
  const WINGS = [
    { id: 'w-angel', name: 'Angel Wings', slot: 'wing', from: 'briefing', at: 16 },
    { id: 'w-raven', name: 'Raven Wings', slot: 'wing', from: 'numbers', at: 14 },
    { id: 'w-flame', name: 'Flame Wings', slot: 'wing', from: 'chronicle', at: 14 },
    { id: 'w-arcane', name: 'Arcane Wings', slot: 'wing', from: 'chronicle', at: 10 },
    { id: 'w-verdant', name: 'Verdant Wings', slot: 'wing', from: 'reader', at: 10 },
    { id: 'w-dusk', name: 'Dusk Wings', slot: 'wing', from: 'reader', at: 16 },
    { id: 'w-spark', name: 'Spark Trail', slot: 'wing', from: 'briefing', at: 10 },
    { id: 'w-comet', name: 'Comet Trail', slot: 'wing', from: 'mapmaster', at: 16 },
    { id: 'w-bolt', name: 'Bolt Trail', slot: 'wing', from: 'numbers', at: 12 },
  ];

  // The rarest things in the game. One per source, all at level 20.
  // Pets run alongside you.
  const PETS = [
    { id: 'p-slime', name: 'Bloop', slot: 'pet', from: 'numbers', at: 20 },
    { id: 'p-cat', name: 'Midnight', slot: 'pet', from: 'reader', at: 20 },
    { id: 'p-pup', name: 'Biscuit', slot: 'pet', from: 'briefing', at: 20 },
    { id: 'p-cub', name: 'Rumble', slot: 'pet', from: 'mapmaster', at: 20 },
  ];
  ...
  const CHARACTERS = [
    ...
    { id: 'c-sentinel', name: 'The Sentinel', sprite: 'sentinel', slot: 'character', from: 'numbers',   at: 2 },
    { id: 'c-monk',     name: 'The Monk',     sprite: 'monk',     slot: 'character', from: 'reader',    at: 2 },
    { id: 'c-tinker',   name: 'The Tinker',   sprite: 'tinker',   slot: 'character', from: 'briefing',  at: 2 },
    { id: 'c-ranger',   name: 'The Ranger',   sprite: 'ranger',   slot: 'character', from: 'mapmaster', at: 6 },
    { id: 'c-druid',    name: 'The Druid',    sprite: 'druid',    slot: 'character', from: 'chronicle', at: 6 },
    { id: 'c-ascetic',  name: 'The Ascetic',  sprite: 'ascetic',  slot: 'character', from: 'reader',    at: 8 },
    { id: 'c-warchief', name: 'The Warchief', sprite: 'warchief', slot: 'character', from: 'mapmaster', at: 11 },
    { id: 'c-kitsune',  name: 'The Kitsune',  sprite: 'kitsune',  slot: 'character', from: 'numbers',   at: 14 },
    { id: 'c-starlit',  name: 'The Starlit',  sprite: 'starlit',  slot: 'character', from: 'chronicle', at: 15 },
    { id: 'c-bulwark',  name: 'The Bulwark',  sprite: 'bulwark',  slot: 'character', from: 'briefing',  at: 16 },
    { id: 'c-infernal', name: 'The Infernal', sprite: 'infernal', slot: 'character', from: 'chronicle', at: 22 },
    { id: 'c-colossus', name: 'The Colossus', sprite: 'colossus', slot: 'character', from: 'mapmaster', at: 24 },
  ];
  ...
  const EXTRAS_ALL = HALOS.concat(ORBITS).concat(WINGS).concat(PETS);
  const ALL = ITEMS.concat(SHOP).concat(CHARACTERS).concat(EXTRAS_ALL);
  /* -------------------------------- chests --------------------------------
   *
  ...
  ITEMS.push(...CHARACTERS, ...EXTRAS_ALL);
  ...
  // What the games hand to Avatar.create as `extras`.
  function extras() {
    const out = {};
  ...
  /* Everything above reads the wardrobe of whoever is sitting here. The roster
     has to draw OTHER people, so this is the same four answers derived from a
     wardrobe blob handed in from outside.
       Wardrobe.look(theirWardrobe) -> { ink, gear, sprite, extras }
     which is exactly the shape Avatar.create expects. Ownership is still
     checked against their own `owned` map: a card claiming a legendary hat
     nobody earned draws the same as no hat at all. */
  function look(state) {
    const s = { owned: {}, equipped: {}, character: null, ink: null, ...(state || {}) };
    const has = (id) => Boolean(id && s.owned[id]);
    const pick = (id) => {
      const item = byId(id);
      return item && has(item.id) ? item : null;
    };

    const g = {};
    SLOTS.forEach((slot) => {
      const item = pick(s.equipped[slot]);
      if (item) g[slot] = art(item);
    });

    const ex = {};
    EXTRA_SLOTS.forEach((slot) => {
      if (has(s.equipped[slot])) ex[slot] = s.equipped[slot];
    });

    const c = pick(s.character);
    const inkItem = pick(s.ink);
    return {
      gear: g,
      extras: ex,
      sprite: (c && c.sprite) || 'runner',
      ink: inkItem ? inkItem.ink : 'var(--p1)',
    };
  }
  ...
  function refresh() {
    bays.forEach((b) => {
      ...
      if (b.sprite !== character()) {
        b.sprite = character();
        b.av = Avatar.create(b.root.querySelector('.wardrobe-figure'), { ink: ink(), gear: gear(), sprite: b.sprite, extras: extras() });
        b.av.pose('idle');
      }
      b.av.setInk(ink());
      b.av.setGear(gear());
      b.av.setExtras(extras());
  ...
  function renderPanel(bay) {
    ...
    PANEL_SLOTS.forEach((slot) => {
      ...
      const grid = el('div', 'wd-cards');

      mine.forEach((i) => {
        const on = slot === 'ink' ? w.ink === i.id
          : slot === 'character' ? w.character === i.id
          : w.equipped[slot] === i.id;
        const card = el('button', `wd-card${on ? ' active' : ''}${i.legendary ? ' legendary' : ''}`,
          '<span class="wd-fig"></span>'
          + `<span class="wd-item-name">${esc(i.name)}</span>`
          + `<span class="wd-item-src">${SOURCE[i.from].icon}</span>`);
        card.title = `${i.name} — ${on ? 'worn' : 'tap to wear'}`;
        card.addEventListener('click', () => equip(slot, i.id));
        grid.appendChild(card);

        // The item is the picture: your own figure wearing it, exactly the
        // trick the shop already uses. A name and a 9px glyph told you what
        // you owned without ever showing you what it looked like.
        const worn = i.slot === 'ink' ? {} : { [i.slot]: art(i) };
        Avatar.create(card.querySelector('.wd-fig'), {
          ink: i.slot === 'ink' ? i.ink : ink(),
          gear: { ...gear(), ...worn },
          // A character is previewed as itself, not as whoever you are now.
          sprite: i.slot === 'character' ? i.sprite : character(),
          extras: EXTRA_SLOTS.includes(i.slot)
            ? { ...extras(), [i.slot]: i.id } : extras(),
        }).pose('idle');
      });
  ...
  function renderShop(bay, body) {
    ...
    list.forEach((i) => {
      ...
      Avatar.create(preview, {
        ...
        gear: { ...gear(), ...worn },
        sprite: character(),
        extras: EXTRA_SLOTS.includes(i.slot) ? { ...extras(), [i.slot]: i.id } : extras(),
      }).pose('idle');
    });
  ...
  function attach(game) {
    ...
    const av = Avatar.create(stage, { ink: ink(), gear: gear(), sprite: character(), extras: extras() });
    av.pose('idle');
  ...
  function reveal(items, coins, after) {
    ...
    const av = Avatar.create(stage, {
      ...
      extras: EXTRA_SLOTS.includes(items[0].slot)
        ? { ...extras(), [items[0].slot]: items[0].id } : extras(),
    });
    av.pose('idle');
  ...
  return {
    ...
    character,
    look,
    // The roster publishes this; it is the minimum another browser needs to
    // draw you. Deliberately not the whole wardrobe — coins, chests and the
    // discovery log are nobody else's business.
    card: () => ({ character: w.character, equipped: w.equipped, owned: w.owned, ink: w.ink }),
    owns,
    found,
    foundDrops,
    remaining,
