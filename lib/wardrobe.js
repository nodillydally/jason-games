...
window.Wardrobe = (function () {
   ...
   */
  const TIERS = [
    { id: 0, name: 'Worn Chest',     rarity: null,        chance: 0.55, coins: [25, 60] },
    { id: 1, name: 'Green Chest',    rarity: 'common',    chance: 0.26, coins: [10, 25] },
    { id: 2, name: 'Steel Chest',    rarity: 'rare',      chance: 0.12, coins: [15, 35] },
    { id: 3, name: 'Emerald Chest',  rarity: 'epic',      chance: 0.05, coins: [30, 70] },
    { id: 4, name: 'Crimson Chest',  rarity: 'legendary', chance: 0.02, coins: [60, 140] },
  ];
  ...
  function load() {
    try {
      ...
      if (raw) return { owned: {}, equipped: {}, flags: {}, ink: null, coins: 0, earned: 0, chests: [], ...JSON.parse(raw) };
    } catch (err) { /* corrupted — start fresh rather than break every game */ }
    return { owned: {}, equipped: {}, flags: {}, ink: null, coins: 0, earned: 0, chests: [] };
  }
  ...
  function attach(game) {
    ...
    purse.title = 'Wallet — open the shop';
